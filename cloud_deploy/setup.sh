...
cp $PROJECT_BASE_PATH/deploy/supervisor_pizza_api.conf /etc/supervisor/conf.d/pizza_api.conf
supervisorctl reread
supervisorctl update
supervisorctl restart pizza_api

# Configure nginx
cp $PROJECT_BASE_PATH/deploy/nginx_pizza_api.conf /etc/nginx/sites-available/pizza_api.conf
